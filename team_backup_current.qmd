...
<tr><td style="height:"10px"><br></td></tr>
  <tr>
    <td style="width:20%;vertical-align: top;">![](images/laisa-pivert.jpeg){width="150px"}</td>
    <td style="width:15px"></td>
    <td style="width:80%;vertical-align: top;"> 
      **Laïsa Pivert** <br>
      Chercheuse postdoctorat <br>
	  Unité départementale des sciences de l'éducation<br>
      Université du Québec à Rimouski
  <div style="height: 10px"></div>
  <div style="display: flex; gap: 20px; justify-content: left;">
 
  <a href="https://www.linkedin.com/in/laïsa-pivert/" target="_blank" style="text-decoration: none;">
    <i class="fab fa-linkedin" style="font-size: 24px; color: #0077b5;"></i>
  </a>
